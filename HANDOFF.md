...
**Dernière mise à jour :** 25 septembre 2026 · l'état courant est dans `ops/` (`ops/journal/2026-09-25.md` pour le détail). En deux jours : cloisonnement OpenRouter terminé — sept projets, sept clés plafonnées à la journée, `Maudios` ne porte plus rien ; les **trois chatbots** lisent désormais le contenu réel de leur site à chaque message, et celui d'Audityo a été construit de zéro ; le prompt du chatbot AInspiration **inventait trois dirigeants, trois études de cas et des chiffres** — purgé ; TVA des mentions légales corrigée et déployée ; limitation de débit posée sur les webhooks de chatbot ; journal Traefik rendu silencieux.
