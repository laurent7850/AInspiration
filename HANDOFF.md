...
**Dernière mise à jour :** 21 septembre 2026 · session Claude Code (l'auto-blog n'a rien publié le 21/09 : un 409 du garde anti-redondance, pas une panne — le tirage du sujet ne visitait qu'un sujet du pool sur deux et rejouait le même tous les 5 mois ; tirage corrigé et vérification des doublons posée **avant** la génération, qui était payée pour rien)
