...
**Dernière mise à jour :** 21 septembre 2026 · session Claude Code (fausse alerte « steal 29 % » : le watchdog mesurait les pires secondes de la minute et accusait un processus qui n'existait pas — sonde corrigée et déployée ; `x2goserver`, inutilisé mais à 14 % d'un cœur, désactivé)
