...
const KNOWN_ROUTES = new Set([
  ...
  '/realisations', '/newsletter-confirmee', '/pme-hainaut-bruxelles',
...
// dependency-free). Listed in files.txt — the container downloads it at boot.
const { escHtml, sanitizeArticleHtml } = require('../sanitize');
