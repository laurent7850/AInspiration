/*
  # Fix tasks table relationships with opportunities, contacts, and companies
  
  1. New Columns
    - Add explicit foreign key columns for relationships
    - Maintain backward compatibility with generic related_to fields
  ...
  3. Data Migration
    - Update new specific foreign keys based on existing related_to data
*/
