/*
  # Add tasks table with opportunity relationship

  1. New Table
    - `tasks` with proper relationship fields to contacts, companies, and opportunities
    - Support for tracking task status, priority, and completion
  ...
  3. Performance
    ...
    - Data migration for existing relationships
*/
