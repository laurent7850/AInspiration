...
const staticRoutes: SitemapRoute[] = [
  ...
  { path: '/realisations/facturation-automatisee', changefreq: 'yearly', priority: 0.7 },
  { path: '/realisations/reconciliation-caisse', changefreq: 'yearly', priority: 0.7 },
  { path: '/realisations/factures-fournisseurs', changefreq: 'yearly', priority: 0.7 },
  { path: '/realisations/chat-ia-site', changefreq: 'yearly', priority: 0.7 },
  { path: '/realisations/audityo', changefreq: 'yearly', priority: 0.7 },
  { path: '/realisations/labo-nostalgie', changefreq: 'yearly', priority: 0.7 },
  { path: '/realisations/autoseo', changefreq: 'yearly', priority: 0.7 },
  { path: '/realisations/preparation-emission', changefreq: 'yearly', priority: 0.7 },
  { path: '/realisations/dreamoracle', changefreq: 'yearly', priority: 0.7 },
  { path: '/realisations/artpero', changefreq: 'yearly', priority: 0.7 },
  { path: '/realisations/tl-services', changefreq: 'yearly', priority: 0.7 },
  { path: '/realisations/playlist-spotify', changefreq: 'yearly', priority: 0.7 },
  { path: '/realisations/veille-youtube', changefreq: 'yearly', priority: 0.7 },
  { path: '/realisations/paperclip', changefreq: 'yearly', priority: 0.7 },
